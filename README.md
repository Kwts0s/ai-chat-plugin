...
| 🎨 **Full branding** | Company name, logo, colors, subtitle, disclaimer, welcome message — all configurable without code |
...
| **Branding** | Company name, subtitle, logo URL, bubble SVG icon, welcome message, disclaimer, online-status label |
| **Appearance** | Primary color, secondary/accent color, widget background, text color, bubble position, border radius, custom CSS |
